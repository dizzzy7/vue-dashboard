<!-- Source: http://web.simmons.edu/~grabiner/comm244/weekthree/html-test-page.html -->
<template>
  <body>
    ...
    <p>
      ...
      purposes, you may use <strong>internal styles</strong>. Recall that these
      CSS rules are placed in between the <code>head</code> tags using the
      following format:
    </p>
